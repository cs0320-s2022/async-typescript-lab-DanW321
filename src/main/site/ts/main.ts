...
let sun: HTMLInputElement
sun = document.getElementById("sun") as HTMLInputElement

let moon: HTMLInputElement
moon = document.getElementById("moon") as HTMLInputElement

let rising: HTMLInputElement
rising = document.getElementById("rising") as HTMLInputElement
...
function updateSuggestions(matches: string[]): void {
  ...
  for(let i = 0; i < matches.length; i++) {
    suggestions.innerHTML += '<li tableindex = \"i\">' + matches[i] + '</li>';
  }
}
